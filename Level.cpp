...
/// Updates the cameras position and stops the camera if
/// we reached the end of the level
...
/// Perform a change in the in-game menu
...
/// Executes the selected option in in-game menu
...
///Moves the camera position. The Wall_Of_Deaths speed is set to the same speed as the camera.
